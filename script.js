...
// alert('Bienvenido ' + name + ' a esta trivia de Los Simpsons');
...
let arraySimpsons = []
arraySimpsons.push(new Simpsons("Homero ", 39 , " Inspector de Seguridad"));
arraySimpsons.push(new Simpsons("Marge ", 36 , " Ama de casa"));
arraySimpsons.push(new Simpsons("Bart ", 10 , " Estudiante"));
arraySimpsons.push(new Simpsons("Lisa ", 8 , " Estudiante"));
arraySimpsons.push(new Simpsons("Magie ", 1 , ""));

for (let i = 0; i < arraySimpsons.length; i++){
  console.log('nombre: ' ,arraySimpsons[i].name + ',edad: ' ,arraySimpsons[i].age + ' ,profesion: ' ,arraySimpsons[i].job )
}

const matrimonio = arraySimpsons.filter((el) => el.age > 30)

console.log("Los padres de la familia son: ");
console.log(matrimonio)

const hijoMayor = arraySimpsons.find((el) => el.age < 11)
console.log("El hijo mayor de la familia es: ")
